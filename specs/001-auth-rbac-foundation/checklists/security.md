...
- [x] CHK010 ¿Se exige de forma explícita que la aplicación se sirva sobre canal cifrado? Ningún requisito lo menciona, y varias decisiones de sesión lo presuponen. [Gap] — **RESUELTO 2026-08-21**: se añadió FR-039, que exige servir la aplicación exclusivamente sobre canal cifrado y fallar el arranque de forma explícita si no lo está, salvo en desarrollo local. Verificado por T097.
- [x] CHK011 ¿Están definidos requisitos sobre el algoritmo de firma del token y la rotación de su clave? [Gap, Spec §FR-015] — **RESUELTO 2026-08-21 en su primera mitad**: el algoritmo queda fijado en **HS256** con clave simétrica única por la decisión D-08a, porque quien firma y quien valida son el mismo proceso. **La rotación de clave sigue abierta a propósito**, ligada a CHK025: con clave única, la única respuesta a una fuga es cambiarla, lo que invalida todas las sesiones de golpe. Aceptable para una sede de diez usuarios, no especificado como procedimiento, y DEBE resolverse antes de exponer la aplicación a internet.
